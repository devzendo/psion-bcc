...
{
   /* op_absf     */ DEST_OVERWRITE | SET_FLAGS,
   ...
   /* op_addf     */ DEST_MODIFY | SET_FLAGS | COMMUTATIVE_INSTR | HAS_OP3,
   ...
   /* op_cmpf     */ SET_FLAGS_FOR_ALL | SET_FLAGS,
   /* op_cmpi     */ SET_FLAGS_FOR_ALL | SET_FLAGS,
   /* op_fix      */ DEST_OVERWRITE | SET_FLAGS,
   /* op_float    */ DEST_OVERWRITE | SET_FLAGS,
#ifdef USE_ALL_OPCODES
   /* op_idle     */ 0,
   /* op_lde      */ DEST_MODIFY,
#endif				/* USE_ALL_OPCODES */
   /* op_ldf      */ DEST_OVERWRITE | SET_FLAGS,
   /* op_popldf   */ DEST_OVERWRITE | SET_FLAGS,
#ifdef USE_ALL_OPCODES
   /* op_ldfi     */ DEST_OVERWRITE | SET_FLAGS,
#endif				/* USE_ALL_OPCODES */
   ...
   /* op_mpyf     */ DEST_MODIFY | SET_FLAGS | COMMUTATIVE_INSTR | HAS_OP3,
   /* op_mpyi     */ DEST_MODIFY | SET_FLAGS | COMMUTATIVE_INSTR | HAS_OP3,
#ifdef USE_ALL_OPCODES
   /* op_negb     */ DEST_OVERWRITE | SET_FLAGS,
#endif				/* USE_ALL_OPCODES */
   /* op_negf     */ DEST_OVERWRITE | SET_FLAGS,
   ...
   /* op_popf     */ DEST_OVERWRITE | SET_FLAGS | USES_SP,
   /* op_push     */ USES_SP,
   /* op_pushf    */ USES_SP,
   /* op_pushnopeep     */ USES_SP,
   /* op_pushfnopeep    */ USES_SP,
   /* op_or       */ DEST_MODIFY | SET_FLAGS | COMMUTATIVE_INSTR | HAS_OP3,
#ifdef USE_ALL_OPCODES
   /* op_rnd      */ DEST_OVERWRITE | SET_FLAGS,
...
#endif				/* USE_ALL_OPCODES */
   /* op_rpts     */ OP_BRANCH,
   /* op_stf      */ DEST_OVERWRITE,
#ifdef USE_ALL_OPCODES
   /* op_stfi     */ DEST_OVERWRITE,
#endif				/* USE_ALL_OPCODES */
...
#endif				/* USE_ALL_OPCODES */
   /* op_subf     */ DEST_MODIFY | SET_FLAGS | COMMUTATIVE_INSTR | HAS_OP3,
   /* op_subi     */ DEST_MODIFY | SET_FLAGS | COMMUTATIVE_INSTR | HAS_OP3,
#ifdef USE_ALL_OPCODES
   /* op_subrb    */ DEST_MODIFY | SET_FLAGS,
#endif				/* USE_ALL_OPCODES */
   /* op_subrf    */ DEST_MODIFY | SET_FLAGS | COMMUTATIVE_INSTR,
...
#endif				/* USE_ALL_OPCODES */
   /* op_addf3    */ DEST_OVERWRITE | SET_FLAGS,
   ...
   /* op_cmpf3    */ SET_FLAGS_FOR_ALL | SET_FLAGS,
   /* op_cmpi3    */ SET_FLAGS_FOR_ALL | SET_FLAGS,
   /* op_lsh3     */ DEST_OVERWRITE | SET_FLAGS,
   /* op_mpyf3    */ DEST_OVERWRITE | SET_FLAGS,
   /* op_mpyi3    */ DEST_OVERWRITE | SET_FLAGS,
   /* op_or3      */ DEST_OVERWRITE | SET_FLAGS,
#ifdef USE_ALL_OPCODES
   /* op_subb3    */ DEST_OVERWRITE | SET_FLAGS,
#endif				/* USE_ALL_OPCODES */
   /* op_subf3    */ DEST_OVERWRITE | SET_FLAGS,
   /* op_subi3    */ DEST_OVERWRITE | SET_FLAGS,
   /* op_tstb3    */ SET_FLAGS_FOR_ALL | SET_FLAGS,
   /* op_xor3     */ DEST_OVERWRITE | SET_FLAGS,
   /* op_ldfu     */ DEST_OVERWRITE,
   /* op_ldflo    */ DEST_MODIFY | USE_FLAGS | USES_CARRY_FLAG,
   /* op_ldfls    */ DEST_MODIFY | USE_FLAGS | USES_CARRY_FLAG,
   /* op_ldfhi    */ DEST_MODIFY | USE_FLAGS | USES_CARRY_FLAG,
   /* op_ldfhs    */ DEST_MODIFY | USE_FLAGS | USES_CARRY_FLAG,
   /* op_ldfeq    */ DEST_MODIFY | USE_FLAGS,
   /* op_ldfne    */ DEST_MODIFY | USE_FLAGS,
   /* op_ldflt    */ DEST_MODIFY | USE_FLAGS,
   /* op_ldfle    */ DEST_MODIFY | USE_FLAGS,
   /* op_ldfgt    */ DEST_MODIFY | USE_FLAGS,
   /* op_ldfge    */ DEST_MODIFY | USE_FLAGS,
   /* op_ldfz     */ DEST_MODIFY | USE_FLAGS,
   /* op_ldfnz    */ DEST_MODIFY | USE_FLAGS,
   /* op_ldfp     */ DEST_MODIFY | USE_FLAGS,
   /* op_ldfn     */ DEST_MODIFY | USE_FLAGS,
   /* op_ldfnn    */ DEST_MODIFY | USE_FLAGS,
   ...
   /* op_mpf3_adf3 */ PAR_DEST_OVERWRITE,
   /* op_mpf3_sbf3 */ PAR_DEST_OVERWRITE,
   /* op_mpi3_adi3 */ PAR_DEST_OVERWRITE,
   /* op_mpi3_sbi3 */ PAR_DEST_OVERWRITE,
#endif				/* USE_ALL_OPCODES */
   /* op_stf_stf  */ PAR_DEST_OVERWRITE,
   /* op_sti_sti  */ PAR_DEST_OVERWRITE,
   /* op_ldf_ldf  */ PAR_DEST_OVERWRITE,
   /* op_ldi_ldi  */ PAR_DEST_OVERWRITE,
   /* op_absf_stf */ PAR_DEST_OVERWRITE | SET_FLAGS,
   /* op_absi_sti */ PAR_DEST_OVERWRITE | SET_FLAGS,
   /* op_addf3_stf */ PAR_DEST_OVERWRITE | SET_FLAGS,
   ...
   /* op_fix_sti  */ PAR_DEST_OVERWRITE | SET_FLAGS,
   /* op_float_stf */ PAR_DEST_OVERWRITE | SET_FLAGS,
   /* op_ldf_stf  */ PAR_DEST_OVERWRITE,
   /* op_ldi_sti  */ PAR_DEST_OVERWRITE,
   /* op_lsh3_sti */ PAR_DEST_OVERWRITE | SET_FLAGS,
   /* op_mpyf3_stf */ PAR_DEST_OVERWRITE | SET_FLAGS,
   /* op_mpyi3_sti */ PAR_DEST_OVERWRITE | SET_FLAGS,
   /* op_negf_stf */ PAR_DEST_OVERWRITE | SET_FLAGS,
   /* op_negi_sti */ PAR_DEST_OVERWRITE | SET_FLAGS,
   /* op_not_sti  */ PAR_DEST_OVERWRITE | SET_FLAGS,
   /* op_or3_sti  */ PAR_DEST_OVERWRITE | SET_FLAGS,
   /* op_subf3_stf */ PAR_DEST_OVERWRITE | SET_FLAGS,
...
BOOL is_equal_address P2 (ADDRESS *, ap1, ADDRESS *, ap2)
{
	...
	return
	    ...
	    (ap1->u.offset->nodetype == en_icon &&
	     ap2->u.offset->nodetype == en_icon &&
	     ap1->u.offset->v.i == ap2->u.offset->v.i)
	    || (ap1->u.offset->nodetype == en_labcon &&
		ap2->u.offset->nodetype == en_labcon &&
		ap1->u.offset->v.l == ap2->u.offset->v.l);
 ...
 * address register of the one is not to be used by the other one).
 */
...
static BOOL is_value_used P2 (REG, reg, CODE *, ip)
{
	...
	case op_brd:
	    /*
	     * bu is used in switchtable, so we cannot say, assume
	     * value is used, thats save in any case
	     * brd shuld not be found in this stage of
...
static BOOL is_remap_possible_bwd P3 (REG, search_reg, REG, replace, CODE *, ip)
{
	...
	case op_bud:
	case op_brd:
	    /* We shuld have found a label before we reach here, else
	     * this is dead code, so we can swap what we want
	     */
	    return TRUE;
...
static CODE *code P8 (OPCODE, op, ILEN, len, ADDRESS *, ap1, ADDRESS *, ap2, ADDRESS *, ap3, ADDRESS *, ap21, ADDRESS *, ap22, ADDRESS *, ap23)
{
    CODE   *newcode;
 ...
 */
void g_code P4 (OPCODE, op, int, len, ADDRESS *, ap1, ADDRESS *, ap2)
{
    add_peep (code (op, (ILEN) len, ap1, NIL_ADDRESS, ap2, NIL_ADDRESS, NIL_ADDRESS, NIL_ADDRESS));
}

void g_code3 P5 (OPCODE, op, int, len, ADDRESS *, ap1, ADDRESS *, ap2, ADDRESS *, ap3)
{
    add_peep (code (op, (ILEN) len, ap1, ap2, ap3, NIL_ADDRESS, NIL_ADDRESS, NIL_ADDRESS));
}

/*
 * Generate a code sequence into the peep list.
 */
void g_code_parallel P8 (OPCODE, op, int, len, ADDRESS *, ap1, ADDRESS *, ap2, ADDRESS *, ap3, ADDRESS *, ap21, ADDRESS *, ap22, ADDRESS *, ap23)
{
...
static void peep_bxx P1 (CODE *, ip)
{
	...
	/* check if the nneded label follows */
	while (p != NIL_CODE && ((p->opcode == op_label)
				 || (p->opcode == op_line))) {
	    if ((p->opcode == op_label) && (p->src1->u.offset->v.l == label)) {
...
static void insert_label P2 (CODE *, ip, CODE *, target)
{
	...
	p = code (op_label, (ILEN) 0, mk_label (nextlabel), NIL_ADDRESS, NIL_ADDRESS, NIL_ADDRESS, NIL_ADDRESS, NIL_ADDRESS);
	p->fwd = target;
	p->back = target->back;
	target->back->fwd = p;
	target->back = p;
...
static void peep_brdelayed P1 (CODE *, ip)
{
	 ...
	 */
	newcode = code (op_asm, (ILEN) OP_INT, mk_branchcomment (), NIL_ADDRESS, NIL_ADDRESS, NIL_ADDRESS, NIL_ADDRESS, NIL_ADDRESS);
	newcode->back = ip;
	newcode->fwd = ip->fwd;
	if (ip->fwd != NIL_CODE) {
	    ip->fwd->back = newcode;
	...
	if (count < 3) {
		...
		if ((p->opcode == op_call)
			...
			if (notdead == FALSE) {
			    ...
			    newcode = code (p->opcode, p->length, p->src1, p->src2, p->dst, p->src21, p->src22, p->dst2);
			    memorywaste++;
			}
...
#endif
	while (count < 3) {
	    newcode = code (op_nop, (ILEN) OP_INT, NIL_ADDRESS, NIL_ADDRESS, NIL_ADDRESS, NIL_ADDRESS, NIL_ADDRESS, NIL_ADDRESS);
	    newcode->back = ip;
	    newcode->fwd = ip->fwd;
	    ip->fwd->back = newcode;
	    ip->fwd = newcode;
...
static void peep_parallel_ldf P1 (CODE *, ip)
{
    ...
    if (opt_parallel_instructions >= OPT_DO_ALL) {
	if ((ip2 != NIL_CODE) && (ip2->opcode == op_stf) &&
 ...
 */
static BOOL was_move_redundant P2 (CODE *, ip, CODE *, ip2)
{
    LABEL   label;
    struct swtab *sw;
...
static void peep_ldi P1 (CODE *, ip)
{
    ...
    if (opt_remove_redundant &&
	is_peep_enabled (REDUNDANT) &&
	was_move_redundant (ip, ip)) {
